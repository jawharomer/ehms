...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = { "com.joh.esms.controller", "com.joh.esms.service", "com.joh.esms.commons",
		"com.joh.esms.dao" })
...
public class SpringContextConfiguraror extends WebMvcConfigurerAdapter {
	...
	public CookieLocaleResolver localeResolver() {
		...
		localeResolver.setCookieName("lang-locale-cookie");
		localeResolver.setCookieMaxAge(3600*30);
